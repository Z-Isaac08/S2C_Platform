...
const FormPayPonct = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Ouvre une nouvelle fenêtre vide si sur téléphone / mobile pour éviter le blocage
        ...
        <div className="grid grid-cols-2 gap-3">
          {modes.map((mode) => (
            <button
              ...
              className={`border rounded-lg p-3 text-center transition duration-200 ${
                formData.moyen_paiement === mode.id
