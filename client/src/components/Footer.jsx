        ...
        <footer className="bg-normal-purple text-white py-4 px-4">
            <div className="flex flex-col items-center justify-center space-y-4 text-center max-w-3xl mx-auto">
                ...
                <div className="flex items-center justify-center space-x-6 mt-4 text-xl">
                    <Link to="https://www.facebook.com/share/1A2FRSr4MG/" className="hover:text-yellow-400">
                        <FaFacebookF />
                    </Link>
                    <Link to="https://youtube.com/@associationchretienneevangeliq?si=cEhd3x3ewoLG8RwT" className="hover:text-yellow-400">
                        <FaYoutube />
                    </Link>
                    <Link to="https://wa.me/2250788257233" className="hover:text-yellow-400">
                        <FaWhatsapp />
                    </Link>
                    <Link to="https://www.instagram.com/ace_esatic?igsh=eHF5dnd0ZjlnaGgx" className="hover:text-yellow-400">
                        <FaInstagram />
                    </Link>
                </div>
